...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002298273843'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/logmkdhsj')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002463403455').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rppr0:rppr0@rppr0.ylpzf.mongodb.net/?retryWrites=true&w=majority&appName=rppr0")
DATABASE_NAME = environ.get('DATABASE_NAME', "rppr0")
